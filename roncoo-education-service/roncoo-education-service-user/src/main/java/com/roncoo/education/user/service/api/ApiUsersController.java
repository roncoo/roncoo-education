...
public class ApiUsersController {
     ...
     */
    @Operation(summary = "验证码发送接口", description = "发送手机验证码")
     ...
     * 用户密码注册接口
     */
    @Operation(summary = "注册接口", description = "注册成功返回登录信息")
     ...
     * 用户密码登录接口
     */
    @Operation(summary = "登录接口", description = "密码登录")
    ...
    @Operation(summary = "微信登录，绑定用户信息", description = "返回用登录信息")
