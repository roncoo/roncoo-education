...
* 如需服务器部署研究学习领课教育系统，可加微信(18302045627)申请获取由[IT云](https://www.doityun.com/)免费提供的1台2核CPU、8G内存、20G磁盘的学习专用云服务器，免费使用时长为1个月。
* 若使用[领课教育系统商业版](https://edu.roncoo.net/)，功能更丰富，全程指导，上线更快速。
