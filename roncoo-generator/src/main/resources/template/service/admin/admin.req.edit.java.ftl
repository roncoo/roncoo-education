package ${cfg.packagePrefix}.${cfg.packageName!}.service.admin.req;
...
<#if swagger2>
@ApiModel(value = "Admin${entity}EditReq", description = "ADMIN-${table.comment!}修改")
</#if>
public class Admin${entity}EditReq implements Serializable {
