...
###### v26.0.0-RELEASE
1. 集成AI
2. Spring Boot版本由3.2.4升级到3.5.0，要求jdk>=17
3. Spring Cloud版升由2023.0.1级到2025.0.0
4. xxl-job版本由3.1.1升级到3.4.0
5. nacos版本由2.3.2升级到3.0.3
6. seata版本由2.0.0升级到2.5.0
---
...
4. 优化验证码生成规则，方便使用
5. 修复密码重置失败的bug
6. Spring Boot版本由2.6.3升级到3.2.4，要求jdk>=17
7. Spring Cloud版升由2021.0.1级到2023.0.1
8. xxl-job版本由2.3.2升级到3.1.1
9. nacos版本由1.4.2升级到2.3.2
10. seata版本由1.6.1升级到2.0.0

---

###### v24.0.0-RELEASE

1. 前端由Vue2升级到Vue3，多个组件进行升级并进行代码重构
2. 增加文档学习功能，课时可以选择文档(word、excel、ppt、pdf等)，不限于音视频
3. 增加余额支付功能，用户可以充值余额，购买课程时，使用余额支付
4. 增加视频播放功能控制，可以控制倍速播放和拖拽播放
5. 移除roncoo-job工程，请使用官方的xxl-job-admin
6. 修复若干处bug，优化代码结构，增加用户体验
