<template>
  ...
  <el-dialog
    ...
    <div class="dialog">
      ...
      <el-form>
        <el-form-item label="">
          <el-input v-model="form.bankChannelCode" clearable placeholder="银行渠道编码" auto-complete="off"></el-input>
          <el-input v-model="form.bankChannelName" clearable placeholder="银行渠道名称" auto-complete="off"></el-input>
  ...
  export default {
    ...
    methods: {
      getList(page) {
        ...
        apis.bankChannelList(this.form, page, this.pageNum).then(res => {
          // console.log(res)
