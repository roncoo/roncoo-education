...
public interface ApiWebsiteNavArticle {
	...
	@RequestMapping(value = "/system/api/website/nav/article/get/{navId}", method = RequestMethod.POST)
	Result<WebsiteNavArticleDTO> get(@PathVariable(value = "navId") Long navId);
}
