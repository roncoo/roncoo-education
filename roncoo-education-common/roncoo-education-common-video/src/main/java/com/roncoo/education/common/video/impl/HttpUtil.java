package com.roncoo.education.common.video.impl;
...
public class HttpUtil {
     ...
     * @throws IOException 读写异常
     */
    public static String get(String url, Map<String, Object> paramMap, String encoding) throws IOException {
     ...
     * @throws IOException 读写异常
     */
    public static byte[] getBinary(String url, Map<String, Object> paramMap, String encoding) throws IOException {
        encoding = encoding == null ? UTF8 : encoding;
        url = appendUrl(url, paramMap);
     ...
     * @throws IOException 读写异常
     */
    public static String postFormBody(String url, Map<String, Object> paramMap) throws IOException {
     ...
     * @throws IOException 读写异常
     */
    public static String postFormBody(String url, Map<String, Object> paramMap, String encoding) throws IOException {
     ...
     * @throws IOException 读写异常
     */
    private static String post(String url, Map<String, Object> paramMap, String encoding) throws IOException {
    ...
    private static <T> T postFileBody(String url, Map<String, Object> paramMap, Map<String, List<File>> fileListMap,
        ...
        if (null != paramMap) {
            for (Map.Entry<String, Object> entry : paramMap.entrySet()) {
                entityBuilder.addTextBody(entry.getKey(), String.valueOf(entry.getValue()), contentType);
            }
        }
     ...
     * @return 拼装好的url
     */
    public static String appendUrl(String url, Map<String, Object> paramMap) throws UnsupportedEncodingException {
        if (paramMap == null) {
            return url;
        }
        StringBuilder paramStringBuilder = new StringBuilder();
        for (Map.Entry<String, Object> next : paramMap.entrySet()) {
            paramStringBuilder.append(next.getKey()).append("=").append(URLEncoder.encode(String.valueOf(next.getValue()), "UTF-8")).append("&");
        }
