...
public Result
<Page
<AdminUsersPageResp>> page(@RequestBody AdminUsersPageReq req) {
    return biz.page(req);
    }
    ...
    public Result
    <String> save(@RequestBody @Valid AdminUsersSaveReq req) {
        return biz.save(req);
        }
        ...
        public Result
        <AdminUsersViewResp> view(@RequestParam Long id) {
            return biz.view(id);
            }
            ...
            public Result
            <String> edit(@RequestBody @Valid AdminUsersEditReq req) {
                return biz.edit(req);
                }
