<template>
  ...
  <el-dialog
    ...
    <div class="dialog">
      ...
      <el-form>
        <el-form-item label="">
          <el-input v-model="form.bankWayCode" clearable placeholder="银行通道编码" auto-complete="off"></el-input>
          <el-input v-model="form.desc" clearable placeholder="银行通道名称" auto-complete="off"></el-input>
