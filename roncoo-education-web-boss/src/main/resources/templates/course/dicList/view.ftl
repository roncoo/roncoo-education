<div class="bjui-pageContent">
    ...
    <div class="form-group">
		<div class="col-lg-6">
			<label class="control-label">字段ID：</label>${bean.fieldId!}
		</div>
	</div>
    <div class="form-group">
		<div class="col-lg-6">
			<label class="control-label">字段KEY：</label>${bean.fieldKey!}
		</div>
	</div>
    <div class="form-group">
		<div class="col-lg-6">
			<label class="control-label">字段VALUE：</label>${bean.fieldValue!}
		</div>
	</div>
</div>
