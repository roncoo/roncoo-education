...
import com.roncoo.education.web.boss.biz.system.SysLogBiz;
...
public class SysLogController extends BaseController {
	...
	private final static String TARGETID = "system-sysLog";

	@Autowired
	private SysLogBiz biz;
	...
	public String save(@ModelAttribute SysLogQO qo){
		if (biz.save(qo) > 0) {
	...
	public String update(@ModelAttribute SysLogQO qo){
