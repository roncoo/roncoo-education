package ${cfg.packagePrefix}.${cfg.packageName!}.common.resp;
...
<#if swagger2>
    @ApiModel(value="${entity}ViewRESP", description="${table.comment!}查看")
</#if>
public class ${entity}ViewRESP implements Serializable {
