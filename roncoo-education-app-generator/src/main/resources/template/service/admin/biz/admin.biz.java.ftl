...
public Result
<Page<#noparse>
<</#noparse>Admin${entity}PageResp<#noparse>></#noparse>> page(Admin${entity}PageReq req) {
    ${entity}Example example = new ${entity}Example();
    Criteria c = example.createCriteria();
    Page<${entity}> page = dao.page(req.getPageCurrent(), req.getPageSize(), example);
    Page
    <Admin${entity}PageResp> respPage = PageUtil.transform(page, Admin${entity}PageResp.class);
        ...
        */
        public Result
        <String> save(Admin${entity}SaveReq req) {
            ...
            */
            public Result
            <Admin${entity}ViewResp> view(Long id) {
                ...
                */
                public Result
                <String> edit(Admin${entity}EditReq req) {
                    ${entity} record = BeanUtil.copyProperties(req, ${entity}.class);
