package ${cfg.packagePrefix}.${cfg.packageName!}.service.api.resp;
...
<#if swagger2>
    @ApiModel(value = "Api${entity}Resp", description = "API-${table.comment!}")
</#if>
public class Api${entity}Resp implements Serializable {
