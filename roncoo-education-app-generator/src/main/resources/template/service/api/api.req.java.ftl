package ${cfg.packagePrefix}.${cfg.packageName!}.service.api.req;
...
<#if swagger2>
    @ApiModel(value = "Api${entity}Req", description = "API-${table.comment!}")
</#if>
public class Api${entity}Req implements Serializable {
