package ${cfg.packagePrefix}.${cfg.packageName!}.service.auth.req;
...
<#if swagger2>
    @ApiModel(value = "Auth${entity}Req", description = "API-AUTH-${table.comment!}")
</#if>
public class Auth${entity}Req implements Serializable {
