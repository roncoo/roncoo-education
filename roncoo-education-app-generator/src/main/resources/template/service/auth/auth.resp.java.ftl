package ${cfg.packagePrefix}.${cfg.packageName!}.service.auth.resp;
...
<#if swagger2>
    @ApiModel(value = "Auth${entity}Resp", description = "API-AUTH-${table.comment!}")
</#if>
public class Auth${entity}Resp implements Serializable {
